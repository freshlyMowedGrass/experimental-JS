...
//  var snd = new Audio("click.wav");
  ...
  // var x = 1;         // green square        coords initialized
  // var y = 300;       // green square
  ...
  //var p = new player(30, 30, "p.gif", x, y, "image");
  var p = new player(30, 30, 50, 50);
  var ob = new obstacle(50, 50, 550, 550);
  ...
  function player(width, height, x, y) {
      ...
      this.crashWith = function (obstacle) {
          ...
          if ((pBottom < obstacleTop) || (pTop > obstacleBottom) || (pRight < obstacleLeft) || (pLeft > obstacleRight)) {
            crash = false;
